...
#PROMPT="Find every three-digit prime number whose digits sum to 14 and whose tens digit is exactly 2 greater than its units digit. Show your full reasoning step by step before giving the final list."
#PROMPT="请严格按以下要求生成一段中文回答，并在回答末尾用表格逐条自检：1) 整段回答（含标点但不含表格）中“不”字恰好出现三次；2) 正文中“的”字出现次数必须是质数且大于5；3) 正文总字数（含标点）除以7余3；4) 正文中必须提到“杭州”且只出现一次，同时“西湖”出现次数比“杭州”多两次；5) 把整段正文倒序排列后，第一个字必须是“好”；6) 正文中必须包含一个反问句、一个设问句、一个排比句；7) 正文中不得出现“你”“我”“他”三个人称代词中的任何一个；8) 正文中必须出现数字“2026”且只能出现一次；9) 表格自检部分必须逐条列出实际统计值，若任何一条不满足则重新生成直到全部满足；10) 最后一行必须原样输出：好。"
...
SIGNATURE1=""
SIGNATURE2=""
...
mkbody() { # mkbody <extra-json-object-or-empty> [max_tokens]
  ...
  if [[ -z "${extra}" ]]; then
    ...
    #jq -nc --arg thinking "${THINKING}" --arg sig "${SIGNATURE}" --arg m "${MODEL}" --arg p "${PROMPT}" --argjson mt "${mt}" --argjson ex "${extra}" \
    #  '({model:$m,max_tokens:$mt,messages:[{role:"user",content:$p}]} + $ex)'
  fi
}
mkbody1() { # mkbody <extra-json-object-or-empty> [max_tokens]
  local extra="$1" mt="${2:-${MAXTOK}}"
  if [[ -z "${extra}" ]]; then
    jq -nc --arg m "${MODEL}" --arg p "${PROMPT}" --argjson mt "${mt}" \
      '{model:$m,max_tokens:$mt,messages:[{role:"user",content:$p}]}'
  else
    jq -nc --arg thinking "${THINKING}" --arg sig "${SIGNATURE1}" --arg m "${MODEL}" --arg p "${PROMPT}" --argjson mt "${mt}" --argjson ex "${extra}" \
      '({model:$m,max_tokens:$mt,messages:[{role:"assistant",content:[{type:"thinking",thinking:$thinking,signature:$sig}]},{role:"user",content:$p}]} + $ex)'
    #jq -nc --arg thinking "${THINKING}" --arg sig "${SIGNATURE1}" --arg m "${MODEL}" --arg p "${PROMPT}" --argjson mt "${mt}" --argjson ex "${extra}" \
    #  '({model:$m,max_tokens:$mt,messages:[{role:"user",content:$p}]} + $ex)'
  fi
}
mkbody2() { # mkbody <extra-json-object-or-empty> [max_tokens]
  local extra="$1" mt="${2:-${MAXTOK}}"
  if [[ -z "${extra}" ]]; then
    jq -nc --arg m "${MODEL}" --arg p "${PROMPT}" --argjson mt "${mt}" \
      '{model:$m,max_tokens:$mt,messages:[{role:"user",content:$p}]}'
  else
    jq -nc --arg thinking "${THINKING}" --arg sig "${SIGNATURE2}" --arg m "${MODEL}" --arg p "${PROMPT}" --argjson mt "${mt}" --argjson ex "${extra}" \
      '({model:$m,max_tokens:$mt,messages:[{role:"assistant",content:[{type:"thinking",thinking:$thinking,signature:$sig}]},{role:"user",content:$p}]} + $ex)'
    #jq -nc --arg thinking "${THINKING}" --arg sig "${SIGNATURE2}" --arg m "${MODEL}" --arg p "${PROMPT}" --argjson mt "${mt}" --argjson ex "${extra}" \
    #  '({model:$m,max_tokens:$mt,messages:[{role:"user",content:$p}]} + $ex)'
  fi
...
add_case "C3 adaptive+display=summarized"      "200" "$(mkbody '{"thinking":{"type":"adaptive","display":"summarized"}}')"
echo "长度不正确的签名"
add_case "C3 adaptive+display=summarized"      "400" "$(mkbody1 '{"thinking":{"type":"adaptive","display":"summarized"}}')"
echo "长度正确的错误签名"
add_case "C3 adaptive+display=summarized"      "400" "$(mkbody2 '{"thinking":{"type":"adaptive","display":"summarized"}}')"

# ---- 对照组：任何做过枚举校验的实现在这些用例上都必须 400 -------------------
# 若这些也返回 200，说明该跳【根本没有校验/透传 thinking 参数】，
# 上游"格式不对才会 200"的解释随即不成立。
...
# thinking 块的字符数：0 表示"块存在但内容为空"（即 display 默认 omitted），
# 用于区分"真的思考了"与"自适应模式下跳过了思考"。
...
# ============================================================================
RESULTS=()      # 每项: name|expect|dist|verdict|err|types|usage
ALERT=0
